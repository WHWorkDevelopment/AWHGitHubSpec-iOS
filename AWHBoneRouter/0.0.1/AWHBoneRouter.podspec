...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/WHWorkDevelopment/AWHBoneRouter-iOS"
  ...
  # s.authors            = { "王恒" => "1066026709@qq.com" }
   s.social_media_url   = "https://github.com/WHWorkDevelopment/AWHBoneRouter-iOS.git"
  ...
  s.source       = { :git => "https://github.com/WHWorkDevelopment/AWHBoneRouter-iOS.git", :tag => "#{s.version}" }
