#
#  Be sure to run `pod spec lint AWHBoneResources.podspec' to ensure this is a
#  确保运行“pod spec lint AWHBoneResources.podspec”以确保这是一个
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/WHWorkDevelopment/AWHBoneResources-iOS"
  ...
  s.source       = { :git => "https://github.com/WHWorkDevelopment/AWHBoneResources-iOS.git", :tag => "#{s.version}" }
