...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/WHWorkDevelopment/AWHBNetworkRequest-iOS"
  ...
  s.source       = { :git => "https://github.com/WHWorkDevelopment/AWHBNetworkRequest-iOS.git", :tag => "#{s.version}" }
...
#  s.public_header_files = "AWHBNetworkRequest/*.h"
  ...
  # s.resource  = "icon.png"
  #s.resources = ['Resources/AWHBNetworkRequestLocalizable.bundle']
